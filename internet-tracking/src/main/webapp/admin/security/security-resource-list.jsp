...
<div class="mTitle">
  ...
  <b class="bbig">安全资源列表</b>
</div>
<s:form  id="searchForm" action="security-resource-list" namespace="/admin/security">
...
<table class="listTable">
  ...
  <tr>  
    ...
    <td> 
    	<a href="<s:url action="security-resource!edit" namespace="/admin/security"/>?requestId=<s:property value="id"/>">修改</a>  
    	<a href="<s:url action="security-resource!delete" namespace="/admin/security"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a>  
    </td>
  </tr>
  </s:iterator>
</table>
...
<div class="Toolbar">
  <div class="toolBt">
 		<a href="<s:url action="security-resource!input" namespace="/admin/security"/>" title="新建"><span class="btn">新建</span></a>
  </div>
