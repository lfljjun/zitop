...
<s:form  id="searchForm" action="role-list" namespace="/admin/security">
...
<table class="listTable">
  ...
  <tr>  
    ...
    <td> 
    	<a href="<s:url action="role!edit" namespace="/admin/security"/>?requestId=<s:property value="id"/>">修改</a>  
    	<a href="<s:url action="role!delete" namespace="/admin/security"/>?requestId=<s:property value="id"/>"  onclick="return confirmDel();">删除</a>  
    	<a href="<s:url action="role-security-resource-list" namespace="/admin/security"/>?roleId=<s:property value="id"/>" >分配权限</a>  
    	<a href="<s:url action="role-user-list" namespace="/admin/security"/>?roleId=<s:property value="id"/>" >分配用户</a>  
    </td>
  </tr>
  </s:iterator>
</table>
...
<div class="Toolbar">
  <div class="toolBt">
 		<a href="<s:url action="role!input" namespace="/admin/security"/>" title="新建"><span class="btn">新建</span></a>
  </div>
