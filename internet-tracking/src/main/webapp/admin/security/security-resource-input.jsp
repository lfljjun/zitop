...
$(document).ready(function(){
 	...
 	$("#value").formValidator({onshow:"",onfocus:"值不能为空",oncorrect:""}).inputValidator({min:1,max:100,onerror:"值不能为空"});
});
</script>
</head>
<body>
...
<table class="addTable">
  <tr>
    <th>类型：</th> 
	<td> <s:select list="#{'URL':'URL'}" name="type"></s:select> </td>
  </tr>
  <tr>
    <th>名称：</th> 
  ...
  <tr>
    <th>值：</th> 
	<td> <s:textfield name="value" id="value" size="90"></s:textfield><span id="valueTip"></span> </td>
  </tr>
  <!-- <tr>
    <th>是否预设：</th> 
...
<div class="addToolbar">
    ...
    <button class="btn" type="button" onclick="location.href='<s:url action="security-resource-list" namespace="/admin/security"/>?restore_params=true'">取消</button></p>
</div>
